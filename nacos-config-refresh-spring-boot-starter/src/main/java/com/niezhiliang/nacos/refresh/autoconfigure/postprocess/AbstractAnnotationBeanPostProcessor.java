...
import static com.niezhiliang.nacos.refresh.autoconfigure.utils.AnnotationUtils.getAnnotationAttributes;
            ...
            public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                ...
                for (Class<? extends Annotation> annotationType : getAnnotationTypes()) {
                    ...
                    AnnotationAttributes attributes =
                        getAnnotationAttributes(field, annotationType, getEnvironment(), true, true);
        ...
        ReflectionUtils.doWithMethods(beanClass, new ReflectionUtils.MethodCallback() {
            ...
            public void doWith(Method method) throws IllegalArgumentException, IllegalAccessException {
                ...
                for (Class<? extends Annotation> annotationType : getAnnotationTypes()) {
                    ...
                    AnnotationAttributes attributes =
                        getAnnotationAttributes(bridgedMethod, annotationType, getEnvironment(), true, true);
